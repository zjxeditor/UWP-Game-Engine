#include "pch.h"
#include "ShadowObjectsRenderer.h"
...
ShadowObjectsRenderer::ShadowObjectsRenderer(const std::shared_ptr<DX::DeviceResources>& deviceResources, const std::shared_ptr<DX::Camera>& camera)
	: m_loadingComplete(false), m_initialized(false), m_deviceResources(deviceResources), m_camera(camera), m_lightRotationAngle(0.0f)
{
	...
	//m_dirLights[0].Direction = XMFLOAT3(10.0f/sqrtf(125.0f), -5.0f/sqrtf(125.0f), 0.0f);
	//m_dirLights[0].Direction = XMFLOAT3(10.0f/sqrtf(116.0f), -4.0f/sqrtf(116.0f), 0.0f);
	//m_dirLights[0].Direction = XMFLOAT3(10.0f/sqrtf(109.0f), -3.0f/sqrtf(109.0f), 0.0f);
...
void ShadowObjectsRenderer::Initialize()
{
...
void ShadowObjectsRenderer::CreateDeviceDependentResources()
{
	assert(IsMainThread());
...
void ShadowObjectsRenderer::CreateWindowSizeDependentResources()
{
	// To do: create windows size related objects
}

// Called once per frame, rotates the cube and calculates the model and view matrices.
void ShadowObjectsRenderer::Update(DX::GameTimer const& timer)
{
...
void ShadowObjectsRenderer::Render()
{
...
void ShadowObjectsRenderer::ReleaseDeviceDependentResources()
{
...
void ShadowObjectsRenderer::InitSkull()
{
	// Init skull
...
void ShadowObjectsRenderer::InitSphere()
{
	// Init spheres
	BasicObjectData* objectData = new BasicObjectData();
	objectData->UseIndex = true;
...
void ShadowObjectsRenderer::InitBase()
{
	// Init base objects
	BasicObjectData* objectData = new BasicObjectData();
	objectData->UseIndex = true;
...
// Input control
void ShadowObjectsRenderer::OnPointerPressed(Windows::UI::Core::PointerEventArgs^ args)
{

}
void ShadowObjectsRenderer::OnPointerReleased(Windows::UI::Core::PointerEventArgs^ args)
{

}
void ShadowObjectsRenderer::OnPointerMoved(Windows::UI::Core::PointerEventArgs^ args)
{

}
void ShadowObjectsRenderer::OnKeyDown(Windows::UI::Core::KeyEventArgs^ args)
{
}
void ShadowObjectsRenderer::OnKeyUp(Windows::UI::Core::KeyEventArgs^ args)
{
}

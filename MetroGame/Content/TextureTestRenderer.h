...
#include "Components\BasicObjects.h"

namespace DXFramework
{
	// This sample renderer instantiates a basic rendering pipeline.
	class TextureTestRenderer
	{
	public:
		TextureTestRenderer(const std::shared_ptr<DX::DeviceResources>& deviceResources, std::shared_ptr<DX::Camera>& camera);

		void Initialize();
		void CreateDeviceDependentResources(DX::TextureMgr* textureMgr, DX::ShaderMgr* shaderMgr);
	...
	private:
		...
		// Custom data
		std::unique_ptr<BasicObjects> m_objects;

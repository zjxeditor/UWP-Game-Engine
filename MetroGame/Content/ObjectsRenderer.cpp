...
ObjectsRenderer::ObjectsRenderer(const std::shared_ptr<DX::DeviceResources>& deviceResources, const std::shared_ptr<DX::Camera>& camera)
...
void ObjectsRenderer::CreateDeviceDependentResources()
{
	assert(IsMainThread());
...
void ObjectsRenderer::CreateWindowSizeDependentResources()
{
	// To do: create windows size related objects
}

// Called once per frame, rotates the cube and calculates the model and view matrices.
void ObjectsRenderer::Update(DX::GameTimer const& timer)
{
...
void ObjectsRenderer::ReleaseDeviceDependentResources()
{
...
void ObjectsRenderer::InitSkull()
{
	// Init skull
...
// Input control
void ObjectsRenderer::OnPointerPressed(Windows::UI::Core::PointerEventArgs^ args)
{

}
void ObjectsRenderer::OnPointerReleased(Windows::UI::Core::PointerEventArgs^ args)
{

}
void ObjectsRenderer::OnPointerMoved(Windows::UI::Core::PointerEventArgs^ args)
{

}
void ObjectsRenderer::OnKeyDown(Windows::UI::Core::KeyEventArgs^ args)
{
}
void ObjectsRenderer::OnKeyUp(Windows::UI::Core::KeyEventArgs^ args)
{
